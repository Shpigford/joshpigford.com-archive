...
ActiveRecord::Schema[7.0].define(version: 2022_05_19_214730) do
  ...
  create_table "arts", force: :cascade do |t|
    ...
    t.date "produced_on"
    t.index ["art_category_id"], name: "index_arts_on_art_category_id"
  end
  ...
  add_foreign_key "arts", "art_categories"
end
